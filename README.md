...
Godot Subreaper is a native GDExtension for Godot 4.x that allows you to
spawn processes with `PR_SET_CHILD_SUBREAPER`. This prevents processes from
spawning and reparent themselves to another process.
